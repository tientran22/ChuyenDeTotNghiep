      ...
      <header className='border-b-2 border-gray-300 py-1'>
        <div className='container'>
          ...
          <div className='flex items-center justify-between gap-10 mt-5 mb-2'>
            ...
            <Popover
              className='bg-white border-2 border-green-700 rounded-full p-3 hover:bg-primary hover:text-white transition-all'
              renderPopover={
                <div className='relative rounded-sm border border-gray-200 bg-white shadow-md max-w-[400px] text-sm p-2'>
                  <div className=''>
                  ...
                  <div className='mt-3'>
                    <div className='flex items-center p-1'>
                      <img
                        src='./src/assets/images/products/chom-chom-nhan-tien-giang.png'
                        alt=''
                        className='w-8 h-8 object-cover flex-shrink-0'
                      />
                      <div className='truncate mx-2 flex-grow'>Chôm chôm nhãn Tiền Giang</div>
                      <span className='text-primary'>100.000đ</span>
                    </div>
                  </div>
                  ...
                  <div className='mt-3'>
                    <div className='flex items-center p-1'>
                      <img
                        ...
                        className='w-8 h-8 object-cover flex-shrink-0'
                      />
                      <div className='truncate mx-2 flex-grow'>
                        Chôm chôm nhãn Tiền Giang Chôm chôm nhãn Tiền Giang Chôm chôm nhãn Tiền Giang
                      </div>
                      <span className='text-primary'>100.000đ</span>
                    </div>
                  </div>
                  ...
                  <div className='flex items-center justify-between mt-2'>
                    <div className='text-gray-700'>Thêm vào giỏ hàng</div>
