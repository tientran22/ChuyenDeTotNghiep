...
export default function FormEditBlog({ isEditModalOpen, closeEditModal, selectedItemId, refetchAdminProducts }: Props) {
  ...
  const EditBlogmutation = useMutation({
    mutationFn: (body: { title: string; content: string; description: string; image: string }) =>
      AdminBlogApi.editBlogs(selectedItemId, body)
  })
          ...
          <div className='relative p-4 w-full max-w-2xl max-h-full'>
            ...
            <div className='relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5'>
              ...
              <div className='flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600'>
                <h3 className='text-lg font-semibold text-gray-900 dark:text-white'>Sửa tin tức</h3>
                <button
              ...
              <form onSubmit={handleEditSubmit}>
                <div className='grid gap-4 mb-4 sm:grid-cols-2'>
                  ...
                  <div className='mb-4 sm:col-span-2'>
                    <span className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Ảnh tin tức</span>
