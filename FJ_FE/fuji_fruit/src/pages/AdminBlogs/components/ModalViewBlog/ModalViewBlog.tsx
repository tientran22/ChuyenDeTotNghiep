...
interface Props {
  ...
  ) => Promise<QueryObserverResult<AxiosResponse<SuccessResponse<Blog[]>>, Error>>
  selectedItemId: string
}
export default function ModalViewBlog({
  isViewModalOpen,
  closeViewModal,
  blogDetail,
  openEditModal,
        ...
        >
          <div className='relative p-4 w-full max-w-xl max-h-full'>
            ...
            <div className='relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5'>
              ...
              <dl>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Nội dung</dt>
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>{blog.content}</dd>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Mô tả</dt>
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>{blog.description}</dd>
