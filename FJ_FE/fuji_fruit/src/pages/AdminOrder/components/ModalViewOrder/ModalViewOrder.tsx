          ...
          <div className='relative p-4 w-full max-w-xl max-h-full'>
            ...
            <div className='relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5'>
              ...
              <dl>
                ...
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>{order.phone_number}</dd>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Địa chỉ giao hàng</dt>
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>{order.delivery_address}</dd>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Tổng tiền đơn hàng</dt>
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>{order.total_amount}</dd>
                ...
                >
                  {' '}
                  {order.status === 'pending' ? 'Đang xử lí' : order.status === 'success' ? 'Thành công' : 'Đã hủy'}
                </dd>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Id người dùng</dt>
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>{order.user_id}</dd>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Lưu ý</dt>
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>{order.note}</dd>
              </dl>
