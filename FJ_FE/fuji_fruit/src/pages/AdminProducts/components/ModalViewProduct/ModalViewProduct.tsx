          ...
          <div className='relative p-4 w-full max-w-xl max-h-full'>
            ...
            <div className='relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5'>
              ...
              <dl>
                ...
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>{product.description}</dd>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Danh mục</dt>
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>
                  {product.category_id === 1 ? 'Giỏ quà tặng' : product.category_id === 2 ? 'Trái cây' : 'Trái cây sấy'}
                </dd>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Thương hiệu</dt>
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>
                  {product.brand_id === 1 ? 'Nội địa' : 'Nhập khẩu'}
                </dd>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Số lượng</dt>
                <dd className='mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400'>{product.quantity}</dd>
                <dt className='mb-2 font-semibold leading-none text-gray-900 dark:text-white'>Ảnh sản phẩm</dt>
                <img
