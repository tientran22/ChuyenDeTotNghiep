...
interface Props {
  ...
  ) => Promise<QueryObserverResult<AxiosResponse<SuccessResponse<Banner[]>>, Error>>
}
export default function FormEditBanner({
  ...
  const EditBannermutation = useMutation({
    mutationFn: (body: { title: string; image: string }) => AdminBannerApi.editBanners(selectedItemId, body)
  })
          ...
          <div className='relative p-4 w-full max-w-2xl max-h-full'>
            ...
            <div className='relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5'>
              ...
              <div className='flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600'>
                <h3 className='text-lg font-semibold text-gray-900 dark:text-white'>Sửa banner</h3>
                <button
